from e2miseg.paths import nnFormer_raw_data, preprocessing_output_dir, nnFormer_cropped_data, network_training_output_dir
...
def convert_id_to_task_name(task_id: int):
    ...
    all_candidates = candidates_cropped + candidates_preprocessed + candidates_raw + candidates_trained_models  # 整合所有候选数据
