...
from e2miseg.paths import nnFormer_raw_data, nnFormer_cropped_data
import numpy as np
import pickle
from e2miseg.preprocessing.cropping import get_patient_identifiers_from_cropped_files
...
class DatasetAnalyzer(object):
        ...
        if self.overwrite or not isfile(self.intensityproperties_file):
            ...
            for mod_id in range(num_modalities):   # num_modalities=1
               ...
               #  3.2354338，3.4708693，2.515819，0，125.6942，0.041799870785325766，12.399157285690308
                ...
                print("median:", median, "mean:", mean, "sd:", sd,"min:", mn, "max:", mx, \
    ...
    def analyze_dataset(self, collect_intensityproperties=True):
        ...
        # size reduction by cropping,尺寸裁剪比率=np.prod(shape_after_crop) / np.prod(shape_before_crop)
