...
from e2miseg.training.data_augmentation.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, ConvertSegmentationToRegionsTransform
from e2miseg.training.data_augmentation.default_data_augmentation import default_3D_augmentation_params
from e2miseg.training.data_augmentation.downsampling import DownsampleSegForDSTransform3, DownsampleSegForDSTransform2
from e2miseg.training.data_augmentation.pyramid_augmentations import MoveSegAsOneHotToData, \
...
def get_moreDA_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
    ...
    ########################################tr_transforms########################################
    # 论文train DA_augmentation：00、01、02、03、04、05、06、07、08、09、10、11、12、13、14
    tr_transforms = []

    if params.get("selected_data_channels") is not None: # None
        tr_transforms.append(DataChannelSelectionTransform(params.get("selected_data_channels")))
    # 00
    if params.get("selected_seg_channels") is not None: # 1
    ...
    ########################################val_transforms########################################
    val_transforms = []
    val_transforms.append(RemoveLabelTransform(-1, 0)) # 00
    if params.get("selected_data_channels") is not None:
        val_transforms.append(DataChannelSelectionTransform(params.get("selected_data_channels")))
    if params.get("selected_seg_channels") is not None:
        val_transforms.append(SegChannelSelectionTransform(params.get("selected_seg_channels"))) #01
