...
import argparse
from e2miseg.preprocessing.preprocessing import resample_data_or_seg
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(e2miseg.__path__[0], "training", "network_training")],
                                                trainerclass,
                                                "e2miseg.training.network_training")
