...
from e2miseg.training.network_training.Trainer_tumor import Trainer_tumor
...
from e2miseg.network_architecture.tumor.e2miseg_tumorv4 import E2MISeg

class e2miseg_trainer_tumor(Trainer_tumor):
    ...
    def initialize_network(self):
        ...
        print("MODEL:", self.network.__class__.__name__)
