...
from e2miseg.training.network_training.network_trainer_tumor import NetworkTrainer_tumor
...
class Trainer_tumor(NetworkTrainer_tumor):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        self.loss = SSDC_and_CE_loss({'batch_dice': self.batch_dice, 'smooth': 1e-5, 'do_bg': False}, {}, weight_dice=1.45, class2=False)
