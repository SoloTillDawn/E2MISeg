...
from e2miseg.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(e2miseg.__path__[0], "training", "network_training"),
                              base_module='e2miseg.training.network_training'):
    ...
    print("network trainer: ", trainer_class)
    ...
    print("\ntraining plan: ", join(dataset_directory, plans['data_identifier']))
