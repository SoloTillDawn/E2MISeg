...
from e2miseg.network_architecture.acdc.transformerblock import HFRBlock
...
class MFGA(nn.Module):
    def     __init__(
        ...
        self.maskout = UnetOutBlock(spatial_dims=3, in_channels=out_channels,out_channels=num_classes)
