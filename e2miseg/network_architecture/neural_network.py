...
from e2miseg.utilities.random_stuff import no_op
from e2miseg.utilities.to_torch import to_cuda, maybe_to_torch
...
class SegmentationNetwork(NeuralNetwork):
    def __init__(self):
        ...
        self.num_classes = None  # number of channels in the output(在输出中有多少个通道
    ...
    def _compute_steps_for_sliding_window(patch_size: Tuple[int, ...], image_size: Tuple[int, ...], step_size: float) -> List[List[int]]:
        ...
        # our step width = patch_size*step_size, but can be narrower. For example if we have image size of
