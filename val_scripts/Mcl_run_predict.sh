...
python ../e2miseg/inference/predict.py -i ..../Task016_Mcl/imagesTs/ -o ..../Task016_Mcl/inferTs -m ../Task016_Mcl/e2miseg_trainer_mcl__unetr_pp_Plansv2.1 -f 0
python ../e2miseg/inference_mcl.py 0
